...
import { View, StyleSheet, Text, TouchableOpacity, FlatList, Modal, Alert, Pressable } from 'react-native';
...
const Timer: FC = () => {
    ...
    const renderItem = ({
        ...
        index: number;
            ...
            <View style={styles.timeline}>
                ...
                {index === 0 ? <View style={styles.largeCircleBorder}></View> : item.label === "Arrêt de l'activité" ? <View style={styles.largeCircleFilled} /> : <View style={styles.smallCircleFilled} />}
            </View>
    ...
    return <View style={styles.container}>
        <LinearGradient colors={['#020716', '#1C4D69', '#EC8F7B', '#FF493E']} style={styles.container}>
